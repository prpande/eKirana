...
import com.eKirana.AuthenticationService.security.SecurityTokenGenerator;
...
public class UserCredentialController {
    ...
    public ResponseEntity<?> updatePassword(@RequestBody String newPassword, HttpServletRequest httpServletRequest) throws UserCredentialsAlreadyExistsException, UserCredentialsNotFoundException {
        try {
            responseEntity = new ResponseEntity<>(userCredentialService.updateUserPassword(getIdFromClaims(httpServletRequest), newPassword), HttpStatus.OK);

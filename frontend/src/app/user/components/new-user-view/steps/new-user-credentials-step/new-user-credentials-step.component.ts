...
export class NewUserCredentialsStepComponent  implements AfterViewInit {
  ...
  @ViewChild(UserCredentialsFormComponent, {static: false}) userCredentialForm!: UserCredentialsFormComponent;
  ...
  createUserCredentials() {
    if (!this.userCredentialForm.done) {
      ...
      //       let savedCredentials: UserCredential = {
      //         userId: data.userId,
      //         userType: data.userType,
      //         password: data.password
      //       }
      //       this.snackBar.open(`Successfully registered UserID: [${userCredentials.userId}]`,
      //         'OK',
